...
function Services() {
    return (
        <div id='services' className='relative min-h-screen px-[40px] pt-[80px] bg-white text-black duration-500 lg:px-[20px] lg:pt-[80px] dark:bg-black dark:text-white '>
            <div className='title'>
            ...
            <div className='gridContent'>
                <div className='serviceBox'>
                    <img className='w-[50px] dark:invert' src={icon1} alt="icon1" />
                ...
                <div className='serviceBox'>
                    <img className='w-[50px] dark:invert' src={icon2} alt="icon2" />
                    <h2 className='serviceBoxH2'>Web Development</h2>
                    <p className='text-center '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem eligendi ratione quisquam. Ut
                        officia perferendis nesciunt laudantium nisi voluptatibus architecto.</p>
                </div>
                <div className='serviceBox'>
                    <img className='w-[50px] dark:invert' src={icon3} alt="icon3" />
                    <h2 className='serviceBoxH2'>Android Apps</h2>
                    <p className='text-center '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem eligendi ratione quisquam. Ut
                        officia perferendis nesciunt laudantium nisi voluptatibus architecto.</p>
                </div>
                <div className='serviceBox'>
                    <img className='w-[50px] dark:invert' src={icon4} alt="icon4" />
                    <h2 className='serviceBoxH2'>Photography</h2>
                    <p className='text-center '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem eligendi ratione quisquam. Ut
                        officia perferendis nesciunt laudantium nisi voluptatibus architecto.</p>
                </div>
                <div className='serviceBox'>
                    <img className='w-[50px] dark:invert' src={icon5} alt="icon5" />
                    <h2 className='serviceBoxH2'>Content Writing</h2>
                    <p className='text-center '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem eligendi ratione quisquam. Ut
                        officia perferendis nesciunt laudantium nisi voluptatibus architecto.</p>
                </div>
                <div className='serviceBox'>
                    <img className='w-[50px] dark:invert' src={icon6} alt="icon6" />
