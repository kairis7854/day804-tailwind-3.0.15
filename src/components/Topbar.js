...
function Topbar({ toggleState, setToggleState }) {
    ...
    return (
        ...
        'fixed top-0 h-[60px]  bg-white [borderBottom:1px_solid_rgba(0,0,0,.05)] px-[40px] flex justify-between items-center z-50  transition-all duration-500  lg:w-full lg:left-0 lg:px-[20px] dark:bg-[#444] dark:[borderBottom:1px_solid_rgba(0,0,0,.5)]')}>
