...
function Navigation({ toggleState }) {
    ...
    return (
        <div className={classNames(toggleState ? 'w-[300px] lg:left-0 lg:w-full  ' : 'w-0 ', 
        'fixed h-full border-1 border-solid border-[rgba(0,0,0,.5)] bg-[#fff] flex justify-center items-center overflow-hidden transition-all lg:left-[-100%]')}>
